...
/**
 * Matches the method handling the player status.
 * Caller must supply the enum type resolved from [PlayerStatusEnumFingerprint].
 */
internal fun playerStatusFingerprint(playerStatusEnumType: String) = Fingerprint(
    classFingerprint = PlayerInitFingerprint,
    accessFlags = listOf(AccessFlags.PUBLIC, AccessFlags.FINAL),
    returnType = "V",
    parameters = listOf(playerStatusEnumType),
    filters = listOf(
...
/**
 * Matches the method returning the channel ID.
 * Caller must supply the player response type resolved from [ChannelInformationFingerprint].
 */
internal fun channelIdMethodCallFingerprint(playerResponseType: String) = Fingerprint(
    accessFlags = listOf(AccessFlags.PUBLIC, AccessFlags.FINAL),
    returnType = "V",
...
/**
 * Matches the method returning the channel name.
 * Caller must supply the player response type resolved from [ChannelInformationFingerprint].
 */
internal fun channelNameMethodCallFingerprint(playerResponseType: String) = Fingerprint(
    filters = listOf(
