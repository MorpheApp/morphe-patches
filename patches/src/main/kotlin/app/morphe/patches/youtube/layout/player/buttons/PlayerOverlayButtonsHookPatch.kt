...
fun addPlayerBottomButton(descriptor: String, methodName: String = "initializeButton") {
    ...
    ExploderUIFullscreenButtonFingerprint.clearMatch()
    exploderButtonInsertIndex = ExploderUIFullscreenButtonFingerprint
        .instructionMatches[1].index

    exploderButtonMethodRef.get()!!.addInstruction(
        exploderButtonInsertIndex + 1,
        "invoke-static { v$exploderButtonInsertRegister }, $descriptor->$methodName(Landroid/view/View;)V"
    )
}
...
internal val playerOverlayButtonsHookPatch = bytecodePatch {
    ...
    execute {
        ExploderUIFullscreenButtonFingerprint.let {
            ...
            exploderButtonInsertRegister = it.instructionMatches[1]
