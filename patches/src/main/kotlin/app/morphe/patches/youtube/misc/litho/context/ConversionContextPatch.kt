...
val conversionContextPatch = bytecodePatch(
    ...
    execute {
        ...
        if (conversionContextClassDef.superclass == "Ljava/lang/Object;") {
            ...
            val identifierMethodName = conversionContextIdentifierFingerprint(
                conversionContextClassType = conversionContextClassDef.type,
                identifierField = identifierField
            ).method.name

            val stringBuilderMethodName = conversionContextStringBuilderFingerprint(
                conversionContextClassType = conversionContextClassDef.type,
                stringBuilderField = stringBuilderField
            ).method.name
