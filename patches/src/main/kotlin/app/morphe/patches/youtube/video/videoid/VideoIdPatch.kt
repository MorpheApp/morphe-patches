 ...
 *
 * Be aware, the hook can be called multiple times for the same videoId.
 *
 * @param methodDescriptor which method to call. Params have to be `Ljava/lang/String;`
 */
...
/**
 * Hooks the videoId of every video when loaded.
 * Supports all videos and functions in all situations.
 *
 * First parameter is the videoId.
 ...
 *
 * Note: The videoId returned here may not be the current video that's being played.
...
val videoIdPatch = bytecodePatch(
    description = "Hooks to detect when the videoId changes.",
) {
    dependsOn(
