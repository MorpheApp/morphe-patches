...
public class AccessTokenData {
    ...
    public AccessTokenData(@NonNull JSONObject json) throws JSONException {
        this(json.getString("refresh_token"), json);
    }

    public AccessTokenData(String refreshToken, @NonNull JSONObject json) throws JSONException {
