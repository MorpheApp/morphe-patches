...
import app.morphe.extension.youtube.patches.FullscreenCutoutPaddingPatch.CutoutPaddingMode;
import app.morphe.extension.youtube.patches.FullscreenCutoutPaddingPatch.CutoutPaddingSide;
import app.morphe.extension.youtube.patches.FullscreenCutoutPaddingPatch.FullscreenCutoutExtraMarginAvailability;
import app.morphe.extension.youtube.patches.FullscreenCutoutPaddingPatch.FullscreenCutoutPaddingAvailability;
...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final BooleanSetting FULLSCREEN_CUTOUT_PADDING = new BooleanSetting("morphe_fullscreen_cutout_padding", FALSE, new FullscreenCutoutPaddingAvailability());
    public static final EnumSetting<CutoutPaddingMode> FULLSCREEN_CUTOUT_PADDING_MODE = new EnumSetting<>("morphe_fullscreen_cutout_padding_mode", CutoutPaddingMode.AUTOMATIC, parent(FULLSCREEN_CUTOUT_PADDING));
    public static final IntegerSetting FULLSCREEN_CUTOUT_EXTRA_MARGIN = new IntegerSetting("morphe_fullscreen_cutout_extra_margin", 8, new FullscreenCutoutExtraMarginAvailability());
    public static final EnumSetting<CutoutPaddingSide> FULLSCREEN_CUTOUT_MANUAL_SIDE = new EnumSetting<>("morphe_fullscreen_cutout_manual_side", CutoutPaddingSide.AUTOMATIC_CAMERA_RIGHT, parent(FULLSCREEN_CUTOUT_PADDING));
    public static final IntegerSetting FULLSCREEN_CUTOUT_MANUAL_AMOUNT = new IntegerSetting("morphe_fullscreen_cutout_manual_amount", 0, parent(FULLSCREEN_CUTOUT_PADDING));
    ...
    static {
        ...
        SeekBarPreference.register(new SeekBarConfig(QUICK_ACTIONS_TOP_MARGIN,
                0, 32, 1, "dp"));
        SeekBarPreference.register(new SeekBarConfig(FULLSCREEN_CUTOUT_EXTRA_MARGIN,
                0, 48, 1, "dp"));
        SeekBarPreference.register(new SeekBarConfig(FULLSCREEN_CUTOUT_MANUAL_AMOUNT,
                0, 200, 1, "dp"));
