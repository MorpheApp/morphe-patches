...
public class Settings extends SharedYouTubeSettings {
    ...
    // Comments
    public static final BooleanSetting HIDE_COMMENTS_PAGE = new BooleanSetting("morphe_hide_comments_page", FALSE, "morphe_hide_comments_page_dialog_message");
    public static final StringSetting HIDE_COMMENTS_PAGE_FILTER_STRINGS = new StringSetting("morphe_hide_comments_page_filter_strings", "", true, parent(HIDE_COMMENTS_PAGE));
