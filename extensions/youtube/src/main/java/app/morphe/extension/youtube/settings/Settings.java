...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final BooleanSetting ENABLE_PLAYBACK_AUDIO_PITCH = new BooleanSetting("morphe_enable_playback_audio_pitch_controls", TRUE, parent(CUSTOM_SPEED_MENU));
