...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final BooleanSetting FULLSCREEN_CUTOUT_PADDING = new BooleanSetting("morphe_fullscreen_cutout_padding", FALSE);
    ...
    public static final IntegerSetting FULLSCREEN_CUTOUT_EXTRA_MARGIN = new IntegerSetting("morphe_fullscreen_cutout_extra_margin", 8, parent(FULLSCREEN_CUTOUT_PADDING));
