...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final String DEFAULT_LYRICS_CREDIT_LINE_REGEX =
           "A&R,A.Guita,AU,Administer,Administered,Administered By,Administering,Administers,"
            ...
            + "Mixed By,Mixer,Mixers,Mixing,Mixing Studio,Music,OA,OC,OP,OT,Original Lyrics by,"
            ...
            + "Record,Recorded,Recorded At,Recorded By,Recorder,Recorders,Recording,Recordings,"
            ...
            + "专辑,业务联系,业务邮箱,中提,中提琴,中提琴手,中文,中文词SA,主催,主唱,乐器,乐团,乐队,书法,二胡,人声,"
            + "企业宣传,企划,企宣,伴唱,伴奏,伴舞,低音提琴,作曲,作画,作者,作词,修音,修音师,公司,出品,出品人,创作,"
            + "创作者,指挥,创意,制作,制作人,前置混音,剧情,剪纸艺术家,助力推广,助理,协力,厂牌,原唱,原曲,原歌名,"
            + "原版,原画,原编曲,原翻,原著,原词,原词曲,发型,发布,发布者,发行,口琴,口风琴,古筝,合作,合作伙伴,合作者,"
            + "合声,合成,合成器,合音,吉他,后期,吟唱,和声,和音,唢呐,商务,团队,图,图片,图画,地址,场景,场景提供,"
            + "填词,声乐,声音,处理,大提,大提琴,大提琴手,女声,妆造,官方,官方指定音乐合作伙伴,宣传,宣发,宣推,"
            + "富鲁格,导演,封设,封面,小号,小提,小提琴,小提琴手,工作室,工程,工程师,平面设计,弦乐,弦乐团,录音,"
            + "录音室,录音师,录音棚,录制,微信,微博,快手,念白,总企划,总监,总监制,总策划,总顾问,手风琴,打击乐,"
            + "执行,抖音,拍摄,指定音乐合作伙伴,指导,指导老师,推广,摄影,改编,改编词,文案,时长,曲,曲Composer,"
            + "曲Music,曲名,曲绘,曲编,木吉他,木管,杜比全景声,板胡,校准,次中音萨克斯,歌名,歌声,歌手,歌曲,"
            + "歌词改编,歌唱指导,母带,海外配唱执行,海报,混缩,混缩室,混音,混音室,混音师,混音棚,滤镜,演唱,演奏,"
            + "漫画,灯光,版本,版权,版权归属,特别鸣谢,班卓琴,琵琶,电吉他,电钢琴,男声,画,画师,监制,监唱,私人,"
            ...
            + "艺统,花脸,英文,营销,萧笛,萨克斯,视觉,记,设计,词,词Lyricist,词Lyrics,词曲作者,词曲提供,译者,"
            ...
            + "鼓,鼓录音,鼓录音室,鼓录制,鼓机,鼓组编程Drums Arrangement,运营";
