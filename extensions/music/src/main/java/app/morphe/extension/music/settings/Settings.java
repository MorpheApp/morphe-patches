...
public class Settings extends SharedYouTubeSettings {
    ...
    // Player
    public static final BooleanSetting ADD_MINIPLAYER_NEXT_BUTTON = new BooleanSetting("morphe_music_add_miniplayer_next_button", TRUE, true);
    public static final BooleanSetting ADD_MINIPLAYER_PREVIOUS_BUTTON = new BooleanSetting("morphe_music_add_miniplayer_previous_button", TRUE, true);
